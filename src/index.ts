...
const createWindow = (): void => {
  ...
  // Disable maximized window for now, as it seems that the small window is prefered by users.
  // mainWindow.maximize();

  ipcMain.handle("loadFolder", async () =>
  ...
  ipcMain.handle("setFullscreen", (event, flag: boolean) =>
